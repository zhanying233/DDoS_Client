...
import static com.zhanyingwl.www.doConnect.onegetTargetHost;

public class oneUdpSend extends Thread { // 第一引擎攻击发送单元
    ...
    public void run() {
        try {
            ...
            InetAddress ip = InetAddress.getByName(onegetTargetHost);
